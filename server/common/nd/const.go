...
const (
	...
	BuildJob                = "build-job"              // 构建器
	GitJob                  = "git-job"                // Git任务
	LdapTaskProcessJob      = "ldap-task-process-job"
	...
	BuildStartSvg            = "startSvg"
	BuildSuccessSvg          = "successSvg"
	BuildSuccessProgressSvg  = "successProgressSvg"
	BuildFailuresSvg         = "failuresSvg"
	BuildFailuresProgressSvg = "failuresProgressSvg"
	BuildFailedSvg           = "failedSvg"
	BuiltProgressSvg         = "builtProgressSvg"
	BuildStopSvg             = "stopSvg"
...
var MySQLParameterNames = []string{guacamole.FontName, guacamole.FontSize, guacamole.ColorScheme, guacamole.Backspace, guacamole.TerminalType, SocksProxyEnable, SocksProxyHost, SocksProxyPort, SocksProxyUsername, SocksProxyPassword}
