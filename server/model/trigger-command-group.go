...
type TriggerCommandGroup struct {
...
type TriggerCommandGroupForCU struct {
	ID         string          `gorm:"primary_key,type:varchar(36)" json:"id"`
	Name       string          `gorm:"type:varchar(500)" json:"name"`
...
type TriggerCommandGroupForPage struct {
...
func (r *TriggerCommandGroup) TableName() string {
	return "trigger_command_groups"
}
