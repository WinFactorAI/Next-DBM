...
func (api AuthorisedApi) UpdateWebhookPushStatusEndpoint(c echo.Context) error {
	id := c.Param("id")
	...
	if err := service.AuthorisedService.UpdateWebhookPushStatusById(id, status); err != nil {
		return err
	}
