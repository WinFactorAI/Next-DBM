...
function EditorFunctionPanel({ setValue, value, sqlEditorHeight,sqlEditorWidth }) {
  ...
  return (
    <div ref={editableRef} className="aceEditor-box w-full bg-gray-200 FunctionPanel-EditorFunctionPanel">
      <MonacoEditor
        width="100%"
        height="100%"
...
export default EditorFunctionPanel;
